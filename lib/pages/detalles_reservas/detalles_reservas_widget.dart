...
class DetallesReservasWidget extends StatefulWidget {
  const DetallesReservasWidget({Key? key}) : super(key: key);

  @override
  _DetallesReservasWidgetState createState() => _DetallesReservasWidgetState();
}

class _DetallesReservasWidgetState extends State<DetallesReservasWidget>
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 4.0, 0.0, 0.0),
                              child: Text(
                                'Magdalena del Mar - Playa los chicos',
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 8.0, 0.0, 0.0),
                              child: Text(
                                'Vuelo en Paratryke para 4 personas, con grabacion incluida y fotos en el vuelo',
